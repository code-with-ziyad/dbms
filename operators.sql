...
SELECT * FROM university WHERE marks BETWEEN 80 AND 90;

-- IN 
SELECT * FROM university WHERE city IN ("lahore", "karachi");

-- NOT IN

SELECT * FROM university WHERE city NOT IN ("lahore", "karachi");

-- limit

SELECT * FROM university LIMIT 3; 

SELECT * FROM university  WHERE marks > 90 LIMIT 3; 
...
SELECT * FROM university ORDER BY name DESC;
